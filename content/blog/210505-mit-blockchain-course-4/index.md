...
- 비트코인 퍼즐의 난이도는 2009년 처음 시작할 때와 비교해서 수조(Trillions)배가 높아졌습니다. 앞으로도 계속 난이도가 높아질 것이라고는 확실하게 말할 수는 없습니다. 2주마다 지난 2,016블록의 평균 블록 생성 시간을 보고 10분보다 짧았으면 퍼즐이 더 어려워지고, 10분보다 오래 걸렸으면 퍼즐은 더 쉽게 바뀝니다.
