...
### 중앙은행의 목표와 기능
- 경제정책의 목표: 미국 연방준비은행의 'Dual Mandate'는 '최대 고융과 안정적인 가격과 장기이율을 적절히 조절하는 목표를 효과적으로 촉진한다'고 설명합니다.
- 법정화폐의 관리
...
- CBDC 사업을 추진하고 있습니다. 중앙화폐 사업은 블록체인 기술을 사용하지 않습니다.
