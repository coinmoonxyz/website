...
- 세법준수와 보고
  ...
  - 세금처리: 마이닝으로 얻은 코인, 거래로 생신 손익, 포킹이 일어났을 경우, 각각 세금처리방식이 정해져야합니다.
...
- 재정안전위원회(Financial Stability Board)는 초기 평가에 따르면, 크립토금융은 전세계 자본시장에 비교해서 아직 규모가 작습니다.
...
- 암호화폐의 정의--유가증권? 상품? 파생상품? 각각에 따른 법과 정책이 적용됩니다. 예를 들어, 유가증권의 경우, 항상 정보가 비대칭적입니다. 모금을 하는 업체는 투자자보다 항상 더 많은 정보를 가지고 있습니다.
- 개인정보보호
- 투자자보호는 소비자보호를 넘어섭니다.
...
- ICO: 투자와 소비를 위한 크라우드펀딩
  ...
  - 주최인은 미리 마이닝이 된(ㅔremined) 토큰을 스스로에게 배당합니다.
...
- 누가 책임자인지도 중요합니다.
- 특히, 임명직, 하급 공무원들은 불균형의 위험을 안고 있기 때문에, 새롭고 불확실한 것에 대해서 거부하려는 경향이 있습니다.
